...
const MovieDetails = () => {
    ...
    // Load favorites from backend to keep profile and details in sync.
    useEffect(() => {
        const fetchFavorites = async () => {
            ...
            try {
                ...
                setFavorites((response.data.favorites || []).map(String));
            } catch (error) {
    ...
    const handleFavorite = async () => {
        ...
        try {
            const response = await axios.post(
                `${API_BASE_URL}/api/auth/favorites`,
            ...
            <div className="movie__detail">
                ...
                <div className="movie__detailRight">
                    ...
                    <div className="movie__detailRightBottom">
                        ...
                        <p className="synopsisContent">{movie.overview || "Synopsis is not available for this movie."}</p>
                    </div>
                </div>
            </div>
